        ...
        private void btExportData_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (saveFileDialog.FileName != "")
                {
                    ...
                    fs.Close();
                    System.IO.File.WriteAllText(saveFileDialog.FileName, "OrderId,MemberId,OrderDate,Total\r\n");
                    foreach (var order in orderList)
                    {
                        System.IO.File.AppendAllText(saveFileDialog.FileName, order.OrderId + "," + order.MemberId + "," + order.OrderDate + "," + OrderRepository.GetTotalOrderByID(order.OrderId.ToString()) + "\r\n");
                    }
